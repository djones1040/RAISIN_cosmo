...
def anyfig( ):
    ...
    """
    rcParams['text.usetex'] = True # TeX doesn't work on palomides
...
def presfig(figsize=[], wide=True):
    ...
    if wide :
        rcParams['figure.figsize']=[17,9.5]
        rcParams['figure.subplot.wspace']=0.2
        rcParams['figure.subplot.hspace']=0.2
        rcParams['figure.subplot.left']=0.15
    ...
    rcParams['ytick.labelsize']=18     # tick labels bigger
    rcParams['xtick.major.size'] = 10      # major tick size in points
    rcParams['xtick.minor.size'] = 5      # minor tick size in points
    ...
    rcParams['axes.labelsize'] = 25      # fontsize of the x and y labels
    rcParams['axes.titlesize'] = 28      # fontsize of the axes title
    fig = gcf()
    return( fig )
